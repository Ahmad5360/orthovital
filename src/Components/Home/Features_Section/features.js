...
import hours from "../WOV/icons/24-hours.png";
import cons from "../WOV/icons/consultation.png";
    ...
    <section>
      <div className="row">
        <div className="col-md-4" id="box1">
          ...
          <div className="content2">
            ...
            <p>
              ...
              times.We are highest levels of honesty and professionalism at all
              times.
            </p>
          </div>
        </div>
        ...
        <div className="col-md-4" id="box2">
          <div className="t_icon">
            <div>
              <img src={hours} width="60" height="60" alt="24-hours" />
            </div>
          </div>
          <div className="content2 text-center">
            <h3>24/7 Emergency Services</h3>
            <p>
              Praesent fringilla congue eros ut porttitor. Fusce vel metus vel
              diam varius pellentesque. In eget laoreet neque. Praesent
              fringilla congue eros ut porttitor.
            </p>
          </div>
        </div>
        ...
        <div className="col-md-4" id="box1">
          <div className="t_icon">
            <div>
              <img src={cons} width="60" height="60" alt="consultation" />
            </div>
          </div>
          <div className="content2">
